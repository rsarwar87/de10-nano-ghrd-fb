	soc_system u0 (
		...
		.dma_write_master_1_data_sink_data          (<connected-to-dma_write_master_1_data_sink_data>),          //   dma_write_master_1_data_sink.data
		.dma_write_master_1_data_sink_valid         (<connected-to-dma_write_master_1_data_sink_valid>),         //                               .valid
		.dma_write_master_1_data_sink_ready         (<connected-to-dma_write_master_1_data_sink_ready>),         //                               .ready
		.dma_write_master_1_data_sink_startofpacket (<connected-to-dma_write_master_1_data_sink_startofpacket>), //                               .startofpacket
		.dma_write_master_1_data_sink_endofpacket   (<connected-to-dma_write_master_1_data_sink_endofpacket>),   //                               .endofpacket
		.dma_write_master_1_data_sink_empty         (<connected-to-dma_write_master_1_data_sink_empty>),         //                               .empty
