...
module soc_system_mm_interconnect_4 (
		...
		input  wire         mm_bridge_sdram_reset_reset_bridge_in_reset_reset,                  //                  mm_bridge_sdram_reset_reset_bridge_in_reset.reset
		input  wire [31:0]  mm_bridge_sdram_m0_address,                                         //                                           mm_bridge_sdram_m0.address
		output wire         mm_bridge_sdram_m0_waitrequest,                                     //                                                             .waitrequest
		input  wire [0:0]   mm_bridge_sdram_m0_burstcount,                                      //                                                             .burstcount
		input  wire [31:0]  mm_bridge_sdram_m0_byteenable,                                      //                                                             .byteenable
		input  wire         mm_bridge_sdram_m0_read,                                            //                                                             .read
		output wire [255:0] mm_bridge_sdram_m0_readdata,                                        //                                                             .readdata
		output wire         mm_bridge_sdram_m0_readdatavalid,                                   //                                                             .readdatavalid
		input  wire         mm_bridge_sdram_m0_write,                                           //                                                             .write
		input  wire [255:0] mm_bridge_sdram_m0_writedata,                                       //                                                             .writedata
		input  wire         mm_bridge_sdram_m0_debugaccess,                                     //                                                             .debugaccess
	...
	wire          mm_bridge_sdram_m0_translator_avalon_universal_master_0_waitrequest;   // mm_bridge_sdram_m0_agent:av_waitrequest -> mm_bridge_sdram_m0_translator:uav_waitrequest
	wire  [255:0] mm_bridge_sdram_m0_translator_avalon_universal_master_0_readdata;      // mm_bridge_sdram_m0_agent:av_readdata -> mm_bridge_sdram_m0_translator:uav_readdata
	wire          mm_bridge_sdram_m0_translator_avalon_universal_master_0_debugaccess;   // mm_bridge_sdram_m0_translator:uav_debugaccess -> mm_bridge_sdram_m0_agent:av_debugaccess
	wire   [31:0] mm_bridge_sdram_m0_translator_avalon_universal_master_0_address;       // mm_bridge_sdram_m0_translator:uav_address -> mm_bridge_sdram_m0_agent:av_address
	wire          mm_bridge_sdram_m0_translator_avalon_universal_master_0_read;          // mm_bridge_sdram_m0_translator:uav_read -> mm_bridge_sdram_m0_agent:av_read
	wire   [31:0] mm_bridge_sdram_m0_translator_avalon_universal_master_0_byteenable;    // mm_bridge_sdram_m0_translator:uav_byteenable -> mm_bridge_sdram_m0_agent:av_byteenable
	wire          mm_bridge_sdram_m0_translator_avalon_universal_master_0_readdatavalid; // mm_bridge_sdram_m0_agent:av_readdatavalid -> mm_bridge_sdram_m0_translator:uav_readdatavalid
	wire          mm_bridge_sdram_m0_translator_avalon_universal_master_0_lock;          // mm_bridge_sdram_m0_translator:uav_lock -> mm_bridge_sdram_m0_agent:av_lock
	wire          mm_bridge_sdram_m0_translator_avalon_universal_master_0_write;         // mm_bridge_sdram_m0_translator:uav_write -> mm_bridge_sdram_m0_agent:av_write
	wire  [255:0] mm_bridge_sdram_m0_translator_avalon_universal_master_0_writedata;     // mm_bridge_sdram_m0_translator:uav_writedata -> mm_bridge_sdram_m0_agent:av_writedata
	wire    [5:0] mm_bridge_sdram_m0_translator_avalon_universal_master_0_burstcount;    // mm_bridge_sdram_m0_translator:uav_burstcount -> mm_bridge_sdram_m0_agent:av_burstcount
	wire          rsp_mux_src_valid;                                                     // rsp_mux:src_valid -> mm_bridge_sdram_m0_agent:rp_valid
	wire  [363:0] rsp_mux_src_data;                                                      // rsp_mux:src_data -> mm_bridge_sdram_m0_agent:rp_data
	wire          rsp_mux_src_ready;                                                     // mm_bridge_sdram_m0_agent:rp_ready -> rsp_mux:src_ready
	wire    [0:0] rsp_mux_src_channel;                                                   // rsp_mux:src_channel -> mm_bridge_sdram_m0_agent:rp_channel
	wire          rsp_mux_src_startofpacket;                                             // rsp_mux:src_startofpacket -> mm_bridge_sdram_m0_agent:rp_startofpacket
	wire          rsp_mux_src_endofpacket;                                               // rsp_mux:src_endofpacket -> mm_bridge_sdram_m0_agent:rp_endofpacket
	...
	wire          mm_bridge_sdram_m0_agent_cp_valid;                                     // mm_bridge_sdram_m0_agent:cp_valid -> router:sink_valid
	wire  [363:0] mm_bridge_sdram_m0_agent_cp_data;                                      // mm_bridge_sdram_m0_agent:cp_data -> router:sink_data
	wire          mm_bridge_sdram_m0_agent_cp_ready;                                     // router:sink_ready -> mm_bridge_sdram_m0_agent:cp_ready
	wire          mm_bridge_sdram_m0_agent_cp_startofpacket;                             // mm_bridge_sdram_m0_agent:cp_startofpacket -> router:sink_startofpacket
	wire          mm_bridge_sdram_m0_agent_cp_endofpacket;                               // mm_bridge_sdram_m0_agent:cp_endofpacket -> router:sink_endofpacket
	...
	) mm_bridge_sdram_m0_translator (
		.clk                    (clk_0_clk_clk),                                                         //                       clk.clk
		.reset                  (mm_bridge_sdram_reset_reset_bridge_in_reset_reset),                     //                     reset.reset
		.uav_address            (mm_bridge_sdram_m0_translator_avalon_universal_master_0_address),       // avalon_universal_master_0.address
		.uav_burstcount         (mm_bridge_sdram_m0_translator_avalon_universal_master_0_burstcount),    //                          .burstcount
		.uav_read               (mm_bridge_sdram_m0_translator_avalon_universal_master_0_read),          //                          .read
		.uav_write              (mm_bridge_sdram_m0_translator_avalon_universal_master_0_write),         //                          .write
		.uav_waitrequest        (mm_bridge_sdram_m0_translator_avalon_universal_master_0_waitrequest),   //                          .waitrequest
		.uav_readdatavalid      (mm_bridge_sdram_m0_translator_avalon_universal_master_0_readdatavalid), //                          .readdatavalid
		.uav_byteenable         (mm_bridge_sdram_m0_translator_avalon_universal_master_0_byteenable),    //                          .byteenable
		.uav_readdata           (mm_bridge_sdram_m0_translator_avalon_universal_master_0_readdata),      //                          .readdata
		.uav_writedata          (mm_bridge_sdram_m0_translator_avalon_universal_master_0_writedata),     //                          .writedata
		.uav_lock               (mm_bridge_sdram_m0_translator_avalon_universal_master_0_lock),          //                          .lock
		.uav_debugaccess        (mm_bridge_sdram_m0_translator_avalon_universal_master_0_debugaccess),   //                          .debugaccess
		.av_address             (mm_bridge_sdram_m0_address),                                            //      avalon_anti_master_0.address
		.av_waitrequest         (mm_bridge_sdram_m0_waitrequest),                                        //                          .waitrequest
		.av_burstcount          (mm_bridge_sdram_m0_burstcount),                                         //                          .burstcount
		.av_byteenable          (mm_bridge_sdram_m0_byteenable),                                         //                          .byteenable
		.av_read                (mm_bridge_sdram_m0_read),                                               //                          .read
		.av_readdata            (mm_bridge_sdram_m0_readdata),                                           //                          .readdata
		.av_readdatavalid       (mm_bridge_sdram_m0_readdatavalid),                                      //                          .readdatavalid
		.av_write               (mm_bridge_sdram_m0_write),                                              //                          .write
		.av_writedata           (mm_bridge_sdram_m0_writedata),                                          //                          .writedata
		.av_debugaccess         (mm_bridge_sdram_m0_debugaccess),                                        //                          .debugaccess
	...
	altera_merlin_master_agent #(
		...
		.USE_READRESPONSE          (0),
		.USE_WRITERESPONSE         (0)
	) mm_bridge_sdram_m0_agent (
		.clk                   (clk_0_clk_clk),                                                         //       clk.clk
		.reset                 (mm_bridge_sdram_reset_reset_bridge_in_reset_reset),                     // clk_reset.reset
		.av_address            (mm_bridge_sdram_m0_translator_avalon_universal_master_0_address),       //        av.address
		.av_write              (mm_bridge_sdram_m0_translator_avalon_universal_master_0_write),         //          .write
		.av_read               (mm_bridge_sdram_m0_translator_avalon_universal_master_0_read),          //          .read
		.av_writedata          (mm_bridge_sdram_m0_translator_avalon_universal_master_0_writedata),     //          .writedata
		.av_readdata           (mm_bridge_sdram_m0_translator_avalon_universal_master_0_readdata),      //          .readdata
		.av_waitrequest        (mm_bridge_sdram_m0_translator_avalon_universal_master_0_waitrequest),   //          .waitrequest
		.av_readdatavalid      (mm_bridge_sdram_m0_translator_avalon_universal_master_0_readdatavalid), //          .readdatavalid
		.av_byteenable         (mm_bridge_sdram_m0_translator_avalon_universal_master_0_byteenable),    //          .byteenable
		.av_burstcount         (mm_bridge_sdram_m0_translator_avalon_universal_master_0_burstcount),    //          .burstcount
		.av_debugaccess        (mm_bridge_sdram_m0_translator_avalon_universal_master_0_debugaccess),   //          .debugaccess
		.av_lock               (mm_bridge_sdram_m0_translator_avalon_universal_master_0_lock),          //          .lock
		.cp_valid              (mm_bridge_sdram_m0_agent_cp_valid),                                     //        cp.valid
		.cp_data               (mm_bridge_sdram_m0_agent_cp_data),                                      //          .data
		.cp_startofpacket      (mm_bridge_sdram_m0_agent_cp_startofpacket),                             //          .startofpacket
		.cp_endofpacket        (mm_bridge_sdram_m0_agent_cp_endofpacket),                               //          .endofpacket
		.cp_ready              (mm_bridge_sdram_m0_agent_cp_ready),                                     //          .ready
	...
	soc_system_mm_interconnect_4_router router (
		.sink_ready         (mm_bridge_sdram_m0_agent_cp_ready),                 //      sink.ready
		.sink_valid         (mm_bridge_sdram_m0_agent_cp_valid),                 //          .valid
		.sink_data          (mm_bridge_sdram_m0_agent_cp_data),                  //          .data
		.sink_startofpacket (mm_bridge_sdram_m0_agent_cp_startofpacket),         //          .startofpacket
		.sink_endofpacket   (mm_bridge_sdram_m0_agent_cp_endofpacket),           //          .endofpacket
		.clk                (clk_0_clk_clk),                                     //       clk.clk
		.reset              (mm_bridge_sdram_reset_reset_bridge_in_reset_reset), // clk_reset.reset
