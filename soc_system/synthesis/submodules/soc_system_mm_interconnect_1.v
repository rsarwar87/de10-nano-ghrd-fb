...
module soc_system_mm_interconnect_1 (
		...
		input  wire         vip_subsystem_alt_vip_vfr_hdmi_clock_master_reset_reset_bridge_in_reset_reset, // vip_subsystem_alt_vip_vfr_hdmi_clock_master_reset_reset_bridge_in_reset.reset
		...
		input  wire [31:0]  vip_subsystem_alt_vip_vfr_hdmi_avalon_master_address,                          //                            vip_subsystem_alt_vip_vfr_hdmi_avalon_master.address
		output wire         vip_subsystem_alt_vip_vfr_hdmi_avalon_master_waitrequest,                      //                                                                        .waitrequest
		input  wire [5:0]   vip_subsystem_alt_vip_vfr_hdmi_avalon_master_burstcount,                       //                                                                        .burstcount
		input  wire         vip_subsystem_alt_vip_vfr_hdmi_avalon_master_read,                             //                                                                        .read
		output wire [127:0] vip_subsystem_alt_vip_vfr_hdmi_avalon_master_readdata,                         //                                                                        .readdata
		output wire         vip_subsystem_alt_vip_vfr_hdmi_avalon_master_readdatavalid                     //                                                                        .readdatavalid
	);

	wire          vip_subsystem_alt_vip_vfr_hdmi_avalon_master_translator_avalon_universal_master_0_waitrequest;   // vip_subsystem_alt_vip_vfr_hdmi_avalon_master_agent:av_waitrequest -> vip_subsystem_alt_vip_vfr_hdmi_avalon_master_translator:uav_waitrequest
	wire  [127:0] vip_subsystem_alt_vip_vfr_hdmi_avalon_master_translator_avalon_universal_master_0_readdata;      // vip_subsystem_alt_vip_vfr_hdmi_avalon_master_agent:av_readdata -> vip_subsystem_alt_vip_vfr_hdmi_avalon_master_translator:uav_readdata
	wire          vip_subsystem_alt_vip_vfr_hdmi_avalon_master_translator_avalon_universal_master_0_debugaccess;   // vip_subsystem_alt_vip_vfr_hdmi_avalon_master_translator:uav_debugaccess -> vip_subsystem_alt_vip_vfr_hdmi_avalon_master_agent:av_debugaccess
	wire   [31:0] vip_subsystem_alt_vip_vfr_hdmi_avalon_master_translator_avalon_universal_master_0_address;       // vip_subsystem_alt_vip_vfr_hdmi_avalon_master_translator:uav_address -> vip_subsystem_alt_vip_vfr_hdmi_avalon_master_agent:av_address
	wire          vip_subsystem_alt_vip_vfr_hdmi_avalon_master_translator_avalon_universal_master_0_read;          // vip_subsystem_alt_vip_vfr_hdmi_avalon_master_translator:uav_read -> vip_subsystem_alt_vip_vfr_hdmi_avalon_master_agent:av_read
	wire   [15:0] vip_subsystem_alt_vip_vfr_hdmi_avalon_master_translator_avalon_universal_master_0_byteenable;    // vip_subsystem_alt_vip_vfr_hdmi_avalon_master_translator:uav_byteenable -> vip_subsystem_alt_vip_vfr_hdmi_avalon_master_agent:av_byteenable
	wire          vip_subsystem_alt_vip_vfr_hdmi_avalon_master_translator_avalon_universal_master_0_readdatavalid; // vip_subsystem_alt_vip_vfr_hdmi_avalon_master_agent:av_readdatavalid -> vip_subsystem_alt_vip_vfr_hdmi_avalon_master_translator:uav_readdatavalid
	wire          vip_subsystem_alt_vip_vfr_hdmi_avalon_master_translator_avalon_universal_master_0_lock;          // vip_subsystem_alt_vip_vfr_hdmi_avalon_master_translator:uav_lock -> vip_subsystem_alt_vip_vfr_hdmi_avalon_master_agent:av_lock
	wire          vip_subsystem_alt_vip_vfr_hdmi_avalon_master_translator_avalon_universal_master_0_write;         // vip_subsystem_alt_vip_vfr_hdmi_avalon_master_translator:uav_write -> vip_subsystem_alt_vip_vfr_hdmi_avalon_master_agent:av_write
	wire  [127:0] vip_subsystem_alt_vip_vfr_hdmi_avalon_master_translator_avalon_universal_master_0_writedata;     // vip_subsystem_alt_vip_vfr_hdmi_avalon_master_translator:uav_writedata -> vip_subsystem_alt_vip_vfr_hdmi_avalon_master_agent:av_writedata
	wire    [9:0] vip_subsystem_alt_vip_vfr_hdmi_avalon_master_translator_avalon_universal_master_0_burstcount;    // vip_subsystem_alt_vip_vfr_hdmi_avalon_master_translator:uav_burstcount -> vip_subsystem_alt_vip_vfr_hdmi_avalon_master_agent:av_burstcount
	...
	wire          vip_subsystem_alt_vip_vfr_hdmi_avalon_master_agent_cp_valid;                                     // vip_subsystem_alt_vip_vfr_hdmi_avalon_master_agent:cp_valid -> router:sink_valid
	wire  [228:0] vip_subsystem_alt_vip_vfr_hdmi_avalon_master_agent_cp_data;                                      // vip_subsystem_alt_vip_vfr_hdmi_avalon_master_agent:cp_data -> router:sink_data
	wire          vip_subsystem_alt_vip_vfr_hdmi_avalon_master_agent_cp_ready;                                     // router:sink_ready -> vip_subsystem_alt_vip_vfr_hdmi_avalon_master_agent:cp_ready
	wire          vip_subsystem_alt_vip_vfr_hdmi_avalon_master_agent_cp_startofpacket;                             // vip_subsystem_alt_vip_vfr_hdmi_avalon_master_agent:cp_startofpacket -> router:sink_startofpacket
	wire          vip_subsystem_alt_vip_vfr_hdmi_avalon_master_agent_cp_endofpacket;                               // vip_subsystem_alt_vip_vfr_hdmi_avalon_master_agent:cp_endofpacket -> router:sink_endofpacket
	...
	wire          router_src_valid;                                                                                // router:src_valid -> vip_subsystem_alt_vip_vfr_hdmi_avalon_master_limiter:cmd_sink_valid
	wire  [228:0] router_src_data;                                                                                 // router:src_data -> vip_subsystem_alt_vip_vfr_hdmi_avalon_master_limiter:cmd_sink_data
	wire          router_src_ready;                                                                                // vip_subsystem_alt_vip_vfr_hdmi_avalon_master_limiter:cmd_sink_ready -> router:src_ready
	wire    [1:0] router_src_channel;                                                                              // router:src_channel -> vip_subsystem_alt_vip_vfr_hdmi_avalon_master_limiter:cmd_sink_channel
	wire          router_src_startofpacket;                                                                        // router:src_startofpacket -> vip_subsystem_alt_vip_vfr_hdmi_avalon_master_limiter:cmd_sink_startofpacket
	wire          router_src_endofpacket;                                                                          // router:src_endofpacket -> vip_subsystem_alt_vip_vfr_hdmi_avalon_master_limiter:cmd_sink_endofpacket
	wire  [228:0] vip_subsystem_alt_vip_vfr_hdmi_avalon_master_limiter_cmd_src_data;                               // vip_subsystem_alt_vip_vfr_hdmi_avalon_master_limiter:cmd_src_data -> cmd_demux:sink_data
	wire          vip_subsystem_alt_vip_vfr_hdmi_avalon_master_limiter_cmd_src_ready;                              // cmd_demux:sink_ready -> vip_subsystem_alt_vip_vfr_hdmi_avalon_master_limiter:cmd_src_ready
	wire    [1:0] vip_subsystem_alt_vip_vfr_hdmi_avalon_master_limiter_cmd_src_channel;                            // vip_subsystem_alt_vip_vfr_hdmi_avalon_master_limiter:cmd_src_channel -> cmd_demux:sink_channel
	wire          vip_subsystem_alt_vip_vfr_hdmi_avalon_master_limiter_cmd_src_startofpacket;                      // vip_subsystem_alt_vip_vfr_hdmi_avalon_master_limiter:cmd_src_startofpacket -> cmd_demux:sink_startofpacket
	wire          vip_subsystem_alt_vip_vfr_hdmi_avalon_master_limiter_cmd_src_endofpacket;                        // vip_subsystem_alt_vip_vfr_hdmi_avalon_master_limiter:cmd_src_endofpacket -> cmd_demux:sink_endofpacket
	wire          rsp_mux_src_valid;                                                                               // rsp_mux:src_valid -> vip_subsystem_alt_vip_vfr_hdmi_avalon_master_limiter:rsp_sink_valid
	wire  [228:0] rsp_mux_src_data;                                                                                // rsp_mux:src_data -> vip_subsystem_alt_vip_vfr_hdmi_avalon_master_limiter:rsp_sink_data
	wire          rsp_mux_src_ready;                                                                               // vip_subsystem_alt_vip_vfr_hdmi_avalon_master_limiter:rsp_sink_ready -> rsp_mux:src_ready
	wire    [1:0] rsp_mux_src_channel;                                                                             // rsp_mux:src_channel -> vip_subsystem_alt_vip_vfr_hdmi_avalon_master_limiter:rsp_sink_channel
	wire          rsp_mux_src_startofpacket;                                                                       // rsp_mux:src_startofpacket -> vip_subsystem_alt_vip_vfr_hdmi_avalon_master_limiter:rsp_sink_startofpacket
	wire          rsp_mux_src_endofpacket;                                                                         // rsp_mux:src_endofpacket -> vip_subsystem_alt_vip_vfr_hdmi_avalon_master_limiter:rsp_sink_endofpacket
	wire          vip_subsystem_alt_vip_vfr_hdmi_avalon_master_limiter_rsp_src_valid;                              // vip_subsystem_alt_vip_vfr_hdmi_avalon_master_limiter:rsp_src_valid -> vip_subsystem_alt_vip_vfr_hdmi_avalon_master_agent:rp_valid
	wire  [228:0] vip_subsystem_alt_vip_vfr_hdmi_avalon_master_limiter_rsp_src_data;                               // vip_subsystem_alt_vip_vfr_hdmi_avalon_master_limiter:rsp_src_data -> vip_subsystem_alt_vip_vfr_hdmi_avalon_master_agent:rp_data
	wire          vip_subsystem_alt_vip_vfr_hdmi_avalon_master_limiter_rsp_src_ready;                              // vip_subsystem_alt_vip_vfr_hdmi_avalon_master_agent:rp_ready -> vip_subsystem_alt_vip_vfr_hdmi_avalon_master_limiter:rsp_src_ready
	wire    [1:0] vip_subsystem_alt_vip_vfr_hdmi_avalon_master_limiter_rsp_src_channel;                            // vip_subsystem_alt_vip_vfr_hdmi_avalon_master_limiter:rsp_src_channel -> vip_subsystem_alt_vip_vfr_hdmi_avalon_master_agent:rp_channel
	wire          vip_subsystem_alt_vip_vfr_hdmi_avalon_master_limiter_rsp_src_startofpacket;                      // vip_subsystem_alt_vip_vfr_hdmi_avalon_master_limiter:rsp_src_startofpacket -> vip_subsystem_alt_vip_vfr_hdmi_avalon_master_agent:rp_startofpacket
	wire          vip_subsystem_alt_vip_vfr_hdmi_avalon_master_limiter_rsp_src_endofpacket;                        // vip_subsystem_alt_vip_vfr_hdmi_avalon_master_limiter:rsp_src_endofpacket -> vip_subsystem_alt_vip_vfr_hdmi_avalon_master_agent:rp_endofpacket
	...
	wire    [1:0] vip_subsystem_alt_vip_vfr_hdmi_avalon_master_limiter_cmd_valid_data;                             // vip_subsystem_alt_vip_vfr_hdmi_avalon_master_limiter:cmd_src_valid -> cmd_demux:sink_valid
	...
	) vip_subsystem_alt_vip_vfr_hdmi_avalon_master_translator (
		.clk                    (clk_0_clk_clk),                                                                                                                         //                       clk.clk
		.reset                  (vip_subsystem_alt_vip_vfr_hdmi_clock_master_reset_reset_bridge_in_reset_reset),                                                         //                     reset.reset
		.uav_address            (vip_subsystem_alt_vip_vfr_hdmi_avalon_master_translator_avalon_universal_master_0_address),                                             // avalon_universal_master_0.address
		.uav_burstcount         (vip_subsystem_alt_vip_vfr_hdmi_avalon_master_translator_avalon_universal_master_0_burstcount),                                          //                          .burstcount
		.uav_read               (vip_subsystem_alt_vip_vfr_hdmi_avalon_master_translator_avalon_universal_master_0_read),                                                //                          .read
		.uav_write              (vip_subsystem_alt_vip_vfr_hdmi_avalon_master_translator_avalon_universal_master_0_write),                                               //                          .write
		.uav_waitrequest        (vip_subsystem_alt_vip_vfr_hdmi_avalon_master_translator_avalon_universal_master_0_waitrequest),                                         //                          .waitrequest
		.uav_readdatavalid      (vip_subsystem_alt_vip_vfr_hdmi_avalon_master_translator_avalon_universal_master_0_readdatavalid),                                       //                          .readdatavalid
		.uav_byteenable         (vip_subsystem_alt_vip_vfr_hdmi_avalon_master_translator_avalon_universal_master_0_byteenable),                                          //                          .byteenable
		.uav_readdata           (vip_subsystem_alt_vip_vfr_hdmi_avalon_master_translator_avalon_universal_master_0_readdata),                                            //                          .readdata
		.uav_writedata          (vip_subsystem_alt_vip_vfr_hdmi_avalon_master_translator_avalon_universal_master_0_writedata),                                           //                          .writedata
		.uav_lock               (vip_subsystem_alt_vip_vfr_hdmi_avalon_master_translator_avalon_universal_master_0_lock),                                                //                          .lock
		.uav_debugaccess        (vip_subsystem_alt_vip_vfr_hdmi_avalon_master_translator_avalon_universal_master_0_debugaccess),                                         //                          .debugaccess
		.av_address             (vip_subsystem_alt_vip_vfr_hdmi_avalon_master_address),                                                                                  //      avalon_anti_master_0.address
		.av_waitrequest         (vip_subsystem_alt_vip_vfr_hdmi_avalon_master_waitrequest),                                                                              //                          .waitrequest
		.av_burstcount          (vip_subsystem_alt_vip_vfr_hdmi_avalon_master_burstcount),                                                                               //                          .burstcount
		.av_read                (vip_subsystem_alt_vip_vfr_hdmi_avalon_master_read),                                                                                     //                          .read
		.av_readdata            (vip_subsystem_alt_vip_vfr_hdmi_avalon_master_readdata),                                                                                 //                          .readdata
		.av_readdatavalid       (vip_subsystem_alt_vip_vfr_hdmi_avalon_master_readdatavalid),                                                                            //                          .readdatavalid
	...
	altera_merlin_master_agent #(
		...
		.USE_READRESPONSE          (0),
		.USE_WRITERESPONSE         (0)
	) vip_subsystem_alt_vip_vfr_hdmi_avalon_master_agent (
		.clk                   (clk_0_clk_clk),                                                                                   //       clk.clk
		.reset                 (vip_subsystem_alt_vip_vfr_hdmi_clock_master_reset_reset_bridge_in_reset_reset),                   // clk_reset.reset
		.av_address            (vip_subsystem_alt_vip_vfr_hdmi_avalon_master_translator_avalon_universal_master_0_address),       //        av.address
		.av_write              (vip_subsystem_alt_vip_vfr_hdmi_avalon_master_translator_avalon_universal_master_0_write),         //          .write
		.av_read               (vip_subsystem_alt_vip_vfr_hdmi_avalon_master_translator_avalon_universal_master_0_read),          //          .read
		.av_writedata          (vip_subsystem_alt_vip_vfr_hdmi_avalon_master_translator_avalon_universal_master_0_writedata),     //          .writedata
		.av_readdata           (vip_subsystem_alt_vip_vfr_hdmi_avalon_master_translator_avalon_universal_master_0_readdata),      //          .readdata
		.av_waitrequest        (vip_subsystem_alt_vip_vfr_hdmi_avalon_master_translator_avalon_universal_master_0_waitrequest),   //          .waitrequest
		.av_readdatavalid      (vip_subsystem_alt_vip_vfr_hdmi_avalon_master_translator_avalon_universal_master_0_readdatavalid), //          .readdatavalid
		.av_byteenable         (vip_subsystem_alt_vip_vfr_hdmi_avalon_master_translator_avalon_universal_master_0_byteenable),    //          .byteenable
		.av_burstcount         (vip_subsystem_alt_vip_vfr_hdmi_avalon_master_translator_avalon_universal_master_0_burstcount),    //          .burstcount
		.av_debugaccess        (vip_subsystem_alt_vip_vfr_hdmi_avalon_master_translator_avalon_universal_master_0_debugaccess),   //          .debugaccess
		.av_lock               (vip_subsystem_alt_vip_vfr_hdmi_avalon_master_translator_avalon_universal_master_0_lock),          //          .lock
		.cp_valid              (vip_subsystem_alt_vip_vfr_hdmi_avalon_master_agent_cp_valid),                                     //        cp.valid
		.cp_data               (vip_subsystem_alt_vip_vfr_hdmi_avalon_master_agent_cp_data),                                      //          .data
		.cp_startofpacket      (vip_subsystem_alt_vip_vfr_hdmi_avalon_master_agent_cp_startofpacket),                             //          .startofpacket
		.cp_endofpacket        (vip_subsystem_alt_vip_vfr_hdmi_avalon_master_agent_cp_endofpacket),                               //          .endofpacket
		.cp_ready              (vip_subsystem_alt_vip_vfr_hdmi_avalon_master_agent_cp_ready),                                     //          .ready
		.rp_valid              (vip_subsystem_alt_vip_vfr_hdmi_avalon_master_limiter_rsp_src_valid),                              //        rp.valid
		.rp_data               (vip_subsystem_alt_vip_vfr_hdmi_avalon_master_limiter_rsp_src_data),                               //          .data
		.rp_channel            (vip_subsystem_alt_vip_vfr_hdmi_avalon_master_limiter_rsp_src_channel),                            //          .channel
		.rp_startofpacket      (vip_subsystem_alt_vip_vfr_hdmi_avalon_master_limiter_rsp_src_startofpacket),                      //          .startofpacket
		.rp_endofpacket        (vip_subsystem_alt_vip_vfr_hdmi_avalon_master_limiter_rsp_src_endofpacket),                        //          .endofpacket
		.rp_ready              (vip_subsystem_alt_vip_vfr_hdmi_avalon_master_limiter_rsp_src_ready),                              //          .ready
		.av_response           (),                                                                                                // (terminated)
		.av_writeresponsevalid ()                                                                                                 // (terminated)
	);
	...
	soc_system_mm_interconnect_1_router router (
		.sink_ready         (vip_subsystem_alt_vip_vfr_hdmi_avalon_master_agent_cp_ready),                   //      sink.ready
		.sink_valid         (vip_subsystem_alt_vip_vfr_hdmi_avalon_master_agent_cp_valid),                   //          .valid
		.sink_data          (vip_subsystem_alt_vip_vfr_hdmi_avalon_master_agent_cp_data),                    //          .data
		.sink_startofpacket (vip_subsystem_alt_vip_vfr_hdmi_avalon_master_agent_cp_startofpacket),           //          .startofpacket
		.sink_endofpacket   (vip_subsystem_alt_vip_vfr_hdmi_avalon_master_agent_cp_endofpacket),             //          .endofpacket
		.clk                (clk_0_clk_clk),                                                                 //       clk.clk
		.reset              (vip_subsystem_alt_vip_vfr_hdmi_clock_master_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	altera_merlin_traffic_limiter #(
		...
		.REORDER                   (0)
	) vip_subsystem_alt_vip_vfr_hdmi_avalon_master_limiter (
		.clk                    (clk_0_clk_clk),                                                                 //       clk.clk
		.reset                  (vip_subsystem_alt_vip_vfr_hdmi_clock_master_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		...
		.cmd_src_ready          (vip_subsystem_alt_vip_vfr_hdmi_avalon_master_limiter_cmd_src_ready),            //   cmd_src.ready
		.cmd_src_data           (vip_subsystem_alt_vip_vfr_hdmi_avalon_master_limiter_cmd_src_data),             //          .data
		.cmd_src_channel        (vip_subsystem_alt_vip_vfr_hdmi_avalon_master_limiter_cmd_src_channel),          //          .channel
		.cmd_src_startofpacket  (vip_subsystem_alt_vip_vfr_hdmi_avalon_master_limiter_cmd_src_startofpacket),    //          .startofpacket
		.cmd_src_endofpacket    (vip_subsystem_alt_vip_vfr_hdmi_avalon_master_limiter_cmd_src_endofpacket),      //          .endofpacket
		...
		.rsp_src_ready          (vip_subsystem_alt_vip_vfr_hdmi_avalon_master_limiter_rsp_src_ready),            //   rsp_src.ready
		.rsp_src_valid          (vip_subsystem_alt_vip_vfr_hdmi_avalon_master_limiter_rsp_src_valid),            //          .valid
		.rsp_src_data           (vip_subsystem_alt_vip_vfr_hdmi_avalon_master_limiter_rsp_src_data),             //          .data
		.rsp_src_channel        (vip_subsystem_alt_vip_vfr_hdmi_avalon_master_limiter_rsp_src_channel),          //          .channel
		.rsp_src_startofpacket  (vip_subsystem_alt_vip_vfr_hdmi_avalon_master_limiter_rsp_src_startofpacket),    //          .startofpacket
		.rsp_src_endofpacket    (vip_subsystem_alt_vip_vfr_hdmi_avalon_master_limiter_rsp_src_endofpacket),      //          .endofpacket
		.cmd_src_valid          (vip_subsystem_alt_vip_vfr_hdmi_avalon_master_limiter_cmd_valid_data)            // cmd_valid.data
	);
	...
	soc_system_mm_interconnect_1_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                                                                 //        clk.clk
		.reset              (vip_subsystem_alt_vip_vfr_hdmi_clock_master_reset_reset_bridge_in_reset_reset), //  clk_reset.reset
		.sink_ready         (vip_subsystem_alt_vip_vfr_hdmi_avalon_master_limiter_cmd_src_ready),            //       sink.ready
		.sink_channel       (vip_subsystem_alt_vip_vfr_hdmi_avalon_master_limiter_cmd_src_channel),          //           .channel
		.sink_data          (vip_subsystem_alt_vip_vfr_hdmi_avalon_master_limiter_cmd_src_data),             //           .data
		.sink_startofpacket (vip_subsystem_alt_vip_vfr_hdmi_avalon_master_limiter_cmd_src_startofpacket),    //           .startofpacket
		.sink_endofpacket   (vip_subsystem_alt_vip_vfr_hdmi_avalon_master_limiter_cmd_src_endofpacket),      //           .endofpacket
		.sink_valid         (vip_subsystem_alt_vip_vfr_hdmi_avalon_master_limiter_cmd_valid_data),           // sink_valid.data
